...
If you want to contribute to [evmongoose](https://github.com/zhaojh329/evmongoose), please follow these simple rules:
...
2. Clone the repository from your account with:
    ...
    ```
    git clone git@github.com:your_github_username/evmongoose.git
    ```

3. Create a new branch with:

    ```
    git checkout -b "evmongoose-1-fix"
    ```
